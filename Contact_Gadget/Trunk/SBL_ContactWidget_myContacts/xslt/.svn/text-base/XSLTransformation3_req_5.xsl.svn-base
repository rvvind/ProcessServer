...
<!-- @generated mapFile="xslt/XSLTransformation3_req_5.map" md5sum="cd19f719b507500469ebe3936f7b3282" version="7.0.200" -->
<!--
*****************************************************************************
...
<xsl:stylesheet
    ...
    xmlns:io6="http://www.siebel.com/xml/MyContacts%20List%20WPS%20CERN"
    xmlns:xsd="http://www.w3.org/2001/XMLSchema"
    xmlns:out3="wsdl.http://SBL_ContactWidget_myContacts_Lib/Invoke"
    xmlns:io7="http://www.w3.org/2005/08/addressing"
    xmlns:map="http://SBL_ContactWidget_myContacts/xslt/XSLTransformation3_req_5"
  ...
  <!-- root template  -->
  <xsl:template match="/">
    <xsl:apply-templates select="io2:smo" mode="map:XSLTransformation3_req_5"/>
  </xsl:template>

  <!-- This rule represents an element mapping: "io2:smo" to "io2:smo".  -->
  <xsl:template match="io2:smo"  mode="map:XSLTransformation3_req_5">
    <io2:smo>
      <body>
