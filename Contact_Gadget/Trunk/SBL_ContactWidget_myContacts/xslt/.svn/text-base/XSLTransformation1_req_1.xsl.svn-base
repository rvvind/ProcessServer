...
<!-- @generated mapFile="xslt/XSLTransformation1_req_1.map" md5sum="575be26139e3c21d013a0c7eb8d72132" version="7.0.200" -->
<!--
*****************************************************************************
...
<xsl:stylesheet
    ...
    xmlns:map="http://SBL_ContactWidget_myContacts/xslt/XSLTransformation1_req_1"
  ...
  <xsl:template match="body"  mode="map:XSLTransformation1_req_1">
    <body>
      <io2:Contact_spcList_spcUpsert_spcWPS_spcCERN_ContactListUpsert_Input>
        <!-- a structural mapping: "in:ContactListUpsert/io2:Contact_spcList_spcUpsert_spcWPS_spcCERN_ContactListUpsert_Input/io6:ListOfContactListWpsCern"(ListOfContactListWpsCern) to "io6:ListOfContactListWpsCern"(ListOfContactListWpsCern) -->
        <xsl:copy-of select="in:ContactListUpsert/io2:Contact_spcList_spcUpsert_spcWPS_spcCERN_ContactListUpsert_Input/io6:ListOfContactListWpsCern"/>
      </io2:Contact_spcList_spcUpsert_spcWPS_spcCERN_ContactListUpsert_Input>
    </body>
  </xsl:template>
