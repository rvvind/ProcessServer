...
<!-- @generated mapFile="xslt/ContactUpsertV2InputToSBL.map" md5sum="3901c7f0f989a719183f74db8576cc2c" version="7.0.401" -->
<!--
*****************************************************************************
...
*   Output file(s):		smo://smo/name%3Dwsdl-primary/message%3D%257Bhttp%253A%252F%252Fwservice.cerner.com%252FV3%257DContact_spcUpsert_spcWPS_spcCERN_ContactUpsert_Input/xpath%3D%252Fbody/smo.xsd
*
...
<xsl:stylesheet
        ...
        <msl:datamap>
          <dataObject>
            <xsl:attribute name="xsi:type">
              <xsl:value-of select="'out2:Contact_spcUpsert_spcWPS_spcCERN_ContactUpsert_Input'"/>
            </xsl:attribute>
            <xsl:call-template name="map:ContactUpsertV2InputToSBL2">
  ...
  <xsl:template match="body"  mode="map:ContactUpsertV2InputToSBL">
    <body>
      ...
      <out:Contact_spcUpsert_spcWPS_spcCERN_ContactUpsert_Input>
        <!-- a structural mapping: "in4:ContactUpsertV2/in3:Contact_spcUpsert_spcWPS_spcCERN_ContactUpsert_Input/in:ListOfContactWpsCern"(ListOfContactWpsCern) to "io:ListOfContactWpsCern"(ListOfContactWpsCern) -->
        <xsl:apply-templates select="in4:ContactUpsertV2/in3:Contact_spcUpsert_spcWPS_spcCERN_ContactUpsert_Input/in:ListOfContactWpsCern" mode="localListOfContactWpsCernToListOfContactWpsCern_298066175"/>
      </out:Contact_spcUpsert_spcWPS_spcCERN_ContactUpsert_Input>
    </body>
  </xsl:template>

  <!-- This rule represents a type mapping: "body" to "body".  -->
  <xsl:template name="map:ContactUpsertV2InputToSBL2">
    <xsl:param name="body"/>
    <out:Contact_spcUpsert_spcWPS_spcCERN_ContactUpsert_Input>
      <!-- a structural mapping: "$body/in4:ContactUpsertV2/in3:Contact_spcUpsert_spcWPS_spcCERN_ContactUpsert_Input/in:ListOfContactWpsCern"(ListOfContactWpsCern) to "io:ListOfContactWpsCern"(ListOfContactWpsCern) -->
      <xsl:apply-templates select="$body/in4:ContactUpsertV2/in3:Contact_spcUpsert_spcWPS_spcCERN_ContactUpsert_Input/in:ListOfContactWpsCern" mode="localListOfContactWpsCernToListOfContactWpsCern_298066175"/>
    </out:Contact_spcUpsert_spcWPS_spcCERN_ContactUpsert_Input>
  </xsl:template>

  <!-- This rule represents an element mapping: "in:ListOfContactWpsCern" to "io:ListOfContactWpsCern".  -->
  <xsl:template match="in:ListOfContactWpsCern"  mode="localListOfContactWpsCernToListOfContactWpsCern_298066175">
    <io:ListOfContactWpsCern>
      <!-- a for-each transform: "in:Contact"(Contact) to "io:Contact"(Contact) -->
      <xsl:apply-templates select="in:Contact" mode="localContactToContact_1012681744"/>
    </io:ListOfContactWpsCern>
  </xsl:template>

  <!-- This rule represents a for-each transform: "in:Contact" to "io:Contact".  -->
  <xsl:template match="in:Contact"  mode="localContactToContact_1012681744">
    <io:Contact>
      ...
      <xsl:apply-templates select="in:ListOfContact_Account" mode="localListOfContact_AccountToListOfContact_Account_527835589"/>
      ...
      <xsl:apply-templates select="in:ListOfContact_BusinessAddress" mode="localListOfContact_BusinessAddressToListOfContact_BusinessAddress_300773191"/>
      ...
      <xsl:apply-templates select="in:ListOfContact_AlternatePhone" mode="localListOfContact_AlternatePhoneToListOfContact_AlternatePhone_970920075"/>
      <!-- a structural mapping: "in:ListOfAccount"(ListOfAccount) to "io:ListOfAccount"(ListOfAccount) -->
      <xsl:apply-templates select="in:ListOfAccount" mode="localListOfAccountToListOfAccount_746379656"/>
    </io:Contact>
  </xsl:template>

  <!-- This rule represents an element mapping: "in:ListOfContact_Account" to "io:ListOfContact_Account".  -->
  <xsl:template match="in:ListOfContact_Account"  mode="localListOfContact_AccountToListOfContact_Account_527835589">
    <io:ListOfContact_Account>
      <!-- a for-each transform: "in:Contact_Account"(Contact_Account) to "io:Contact_Account"(Contact_Account) -->
      <xsl:apply-templates select="in:Contact_Account" mode="localContact_AccountToContact_Account_1075163252"/>
    </io:ListOfContact_Account>
  </xsl:template>

  <!-- This rule represents a for-each transform: "in:Contact_Account" to "io:Contact_Account".  -->
  <xsl:template match="in:Contact_Account"  mode="localContact_AccountToContact_Account_1075163252">
    <io:Contact_Account>
  ...
  <xsl:template match="in:ListOfContact_BusinessAddress"  mode="localListOfContact_BusinessAddressToListOfContact_BusinessAddress_300773191">
    <io:ListOfContact_BusinessAddress>
      ...
      <xsl:apply-templates select="in:Contact_BusinessAddress" mode="localContact_BusinessAddressToContact_BusinessAddress_522889217"/>
    </io:ListOfContact_BusinessAddress>
  </xsl:template>

  <!-- This rule represents a for-each transform: "in:Contact_BusinessAddress" to "io:Contact_BusinessAddress".  -->
  <xsl:template match="in:Contact_BusinessAddress"  mode="localContact_BusinessAddressToContact_BusinessAddress_522889217">
  ...
  <xsl:template match="in:ListOfContact_AlternatePhone"  mode="localListOfContact_AlternatePhoneToListOfContact_AlternatePhone_970920075">
    <io:ListOfContact_AlternatePhone>
      ...
      <xsl:apply-templates select="in:Contact_AlternatePhone" mode="localContact_AlternatePhoneToContact_AlternatePhone_1953855286"/>
    </io:ListOfContact_AlternatePhone>
  </xsl:template>

  <!-- This rule represents a for-each transform: "in:Contact_AlternatePhone" to "io:Contact_AlternatePhone".  -->
  <xsl:template match="in:Contact_AlternatePhone"  mode="localContact_AlternatePhoneToContact_AlternatePhone_1953855286">
  ...
  <xsl:template match="in:ListOfAccount"  mode="localListOfAccountToListOfAccount_746379656">
    <io:ListOfAccount>
      <!-- a for-each transform: "in:Account"(Account) to "io:Account"(Account) -->
      <xsl:apply-templates select="in:Account" mode="localAccountToAccount_1798324681"/>
    </io:ListOfAccount>
  </xsl:template>

  <!-- This rule represents a for-each transform: "in:Account" to "io:Account".  -->
  <xsl:template match="in:Account"  mode="localAccountToAccount_1798324681">
    <io:Account>
