...
<!-- @generated mapFile="xslt/ContactQueryInputToSBL.map" md5sum="54386d8f3d769c62ad039a327721d150" version="7.0.401" -->
<!--
*****************************************************************************
...
<xsl:stylesheet
      ...
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <dataObject>
            ...
            <xsl:call-template name="map:ContactQueryInputToSBL2">
  ...
  <xsl:template match="body"  mode="map:ContactQueryInputToSBL">
    <body>
      ...
      <out:Contact_spcQuery_spcWPS_spcCERN_ContactQuery_Input>
        <!-- a simple data mapping: "in3:ContactQuery/in4:Contact_spcQuery_spcWPS_spcCERN_ContactQuery_Input/in4:ComplexSearchSpec"(string) to "out:ComplexSearchSpec"(string) -->
        ...
        <xsl:apply-templates select="in3:ContactQuery/in4:Contact_spcQuery_spcWPS_spcCERN_ContactQuery_Input/in5:ListOfContactWpsCern" mode="localListOfContactWpsCernToListOfContactWpsCern_1394353801"/>
      </out:Contact_spcQuery_spcWPS_spcCERN_ContactQuery_Input>
    </body>
  </xsl:template>

  <!-- This rule represents a type mapping: "body" to "body".  -->
  <xsl:template name="map:ContactQueryInputToSBL2">
    <xsl:param name="body"/>
    <out:Contact_spcQuery_spcWPS_spcCERN_ContactQuery_Input>
      <!-- a simple data mapping: "$body/in3:ContactQuery/in4:Contact_spcQuery_spcWPS_spcCERN_ContactQuery_Input/in4:ComplexSearchSpec"(string) to "out:ComplexSearchSpec"(string) -->
      <out:ComplexSearchSpec>
        <xsl:value-of select="$body/in3:ContactQuery/in4:Contact_spcQuery_spcWPS_spcCERN_ContactQuery_Input/in4:ComplexSearchSpec"/>
      </out:ComplexSearchSpec>
      <!-- a structural mapping: "$body/in3:ContactQuery/in4:Contact_spcQuery_spcWPS_spcCERN_ContactQuery_Input/in5:ListOfContactWpsCern"(ListOfContactWpsCern) to "io:ListOfContactWpsCern"(ListOfContactWpsCern) -->
      <xsl:apply-templates select="$body/in3:ContactQuery/in4:Contact_spcQuery_spcWPS_spcCERN_ContactQuery_Input/in5:ListOfContactWpsCern" mode="localListOfContactWpsCernToListOfContactWpsCern_1394353801"/>
    </out:Contact_spcQuery_spcWPS_spcCERN_ContactQuery_Input>
  </xsl:template>

  <!-- This rule represents an element mapping: "in5:ListOfContactWpsCern" to "io:ListOfContactWpsCern".  -->
  <xsl:template match="in5:ListOfContactWpsCern"  mode="localListOfContactWpsCernToListOfContactWpsCern_1394353801">
    <io:ListOfContactWpsCern>
      <!-- a for-each transform: "in5:Contact"(Contact) to "io:Contact"(Contact) -->
      <xsl:apply-templates select="in5:Contact" mode="localContactToContact_224034996"/>
    </io:ListOfContactWpsCern>
  </xsl:template>

  <!-- This rule represents a for-each transform: "in5:Contact" to "io:Contact".  -->
  <xsl:template match="in5:Contact"  mode="localContactToContact_224034996">
    <io:Contact>
      ...
      <xsl:apply-templates select="in5:ListOfContact_Account" mode="localListOfContact_AccountToListOfContact_Account_845729860"/>
      ...
      <xsl:apply-templates select="in5:ListOfContact_BusinessAddress" mode="localListOfContact_BusinessAddressToListOfContact_BusinessAddress_561898782"/>
      ...
      <xsl:apply-templates select="in5:ListOfContact_AlternatePhone" mode="localListOfContact_AlternatePhoneToListOfContact_AlternatePhone_2110933501"/>
      <!-- a structural mapping: "in5:ListOfAccount"(ListOfAccount) to "io:ListOfAccount"(ListOfAccount) -->
      <xsl:apply-templates select="in5:ListOfAccount" mode="localListOfAccountToListOfAccount_440449714"/>
    </io:Contact>
  </xsl:template>

  <!-- This rule represents an element mapping: "in5:ListOfContact_Account" to "io:ListOfContact_Account".  -->
  <xsl:template match="in5:ListOfContact_Account"  mode="localListOfContact_AccountToListOfContact_Account_845729860">
    <io:ListOfContact_Account>
      <!-- a for-each transform: "in5:Contact_Account"(Contact_Account) to "io:Contact_Account"(Contact_Account) -->
      <xsl:apply-templates select="in5:Contact_Account" mode="localContact_AccountToContact_Account_1758401042"/>
    </io:ListOfContact_Account>
  </xsl:template>

  <!-- This rule represents a for-each transform: "in5:Contact_Account" to "io:Contact_Account".  -->
  <xsl:template match="in5:Contact_Account"  mode="localContact_AccountToContact_Account_1758401042">
    <io:Contact_Account>
  ...
  <xsl:template match="in5:ListOfContact_BusinessAddress"  mode="localListOfContact_BusinessAddressToListOfContact_BusinessAddress_561898782">
    <io:ListOfContact_BusinessAddress>
      ...
      <xsl:apply-templates select="in5:Contact_BusinessAddress" mode="localContact_BusinessAddressToContact_BusinessAddress_1664188017"/>
    </io:ListOfContact_BusinessAddress>
  </xsl:template>

  <!-- This rule represents a for-each transform: "in5:Contact_BusinessAddress" to "io:Contact_BusinessAddress".  -->
  <xsl:template match="in5:Contact_BusinessAddress"  mode="localContact_BusinessAddressToContact_BusinessAddress_1664188017">
  ...
  <xsl:template match="in5:ListOfContact_AlternatePhone"  mode="localListOfContact_AlternatePhoneToListOfContact_AlternatePhone_2110933501">
    <io:ListOfContact_AlternatePhone>
      ...
      <xsl:apply-templates select="in5:Contact_AlternatePhone" mode="localContact_AlternatePhoneToContact_AlternatePhone_788506556"/>
    </io:ListOfContact_AlternatePhone>
  </xsl:template>

  <!-- This rule represents a for-each transform: "in5:Contact_AlternatePhone" to "io:Contact_AlternatePhone".  -->
  <xsl:template match="in5:Contact_AlternatePhone"  mode="localContact_AlternatePhoneToContact_AlternatePhone_788506556">
  ...
  <xsl:template match="in5:ListOfAccount"  mode="localListOfAccountToListOfAccount_440449714">
    <io:ListOfAccount>
      <!-- a for-each transform: "in5:Account"(Account) to "io:Account"(Account) -->
      <xsl:apply-templates select="in5:Account" mode="localAccountToAccount_177855342"/>
    </io:ListOfAccount>
  </xsl:template>

  <!-- This rule represents a for-each transform: "in5:Account" to "io:Account".  -->
  <xsl:template match="in5:Account"  mode="localAccountToAccount_177855342">
    <io:Account>
