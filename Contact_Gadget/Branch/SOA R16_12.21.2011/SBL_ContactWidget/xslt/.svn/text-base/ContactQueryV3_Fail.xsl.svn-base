...
<!-- @generated mapFile="xslt/ContactQueryV3_Fail.map" md5sum="4998b42b4072b6076aa0d15dfd613903" version="7.0.401" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM XML Mapping Editor V7.0.401
*
*   Mapping file:		ContactQueryV3_Fail.map
*   Map declaration(s):	ContactQueryV3_Fail
...
*   Output file(s):		smo://smo/name%3Dwsdl-primary/message%3D%257Bhttp%253A%252F%252FSBL_ContactWidget_Lib%252FInvoke%257DContactQueryV3_ContactQueryV3Fault1Msg/xpath%3D%252F/smo.xsd
*
...
<xsl:stylesheet
    ...
    xmlns:map="http://SBL_ContactWidget/xslt/ContactQueryV3_Fail"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <dataObject>
            ...
            <xsl:call-template name="map:ContactQueryV3_Fail2">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io3:smo" mode="map:ContactQueryV3_Fail"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io3:smo" to "io3:smo".  -->
  <xsl:template match="io3:smo"  mode="map:ContactQueryV3_Fail">
    <io3:smo>
      <body>
        <xsl:attribute name="xsi:type">
          <xsl:value-of select="'out3:ContactQueryV3_ContactQueryV3Fault1Msg'"/>
        </xsl:attribute>
        <!-- a simple data mapping: "context/failInfo/failureString"(string) to "out2:ContactQueryV3Fault1"(string) -->
        <out2:ContactQueryV3Fault1>
  ...
  <xsl:template name="map:ContactQueryV3_Fail2">
    <xsl:param name="smo"/>
    <body>
      <xsl:attribute name="xsi:type">
        <xsl:value-of select="'out3:ContactQueryV3_ContactQueryV3Fault1Msg'"/>
      </xsl:attribute>
      <!-- a simple data mapping: "$smo/context/failInfo/failureString"(string) to "out2:ContactQueryV3Fault1"(string) -->
      <out2:ContactQueryV3Fault1>
