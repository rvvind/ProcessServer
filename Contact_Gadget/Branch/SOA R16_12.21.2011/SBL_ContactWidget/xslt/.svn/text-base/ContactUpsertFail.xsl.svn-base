...
<!-- @generated mapFile="xslt/ContactUpsertFail.map" md5sum="bec73ae4da27013aa1aa1a8a9735d67f" version="7.0.401" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM XML Mapping Editor V7.0.401
*
*   Mapping file:		ContactUpsertFail.map
*   Map declaration(s):	ContactUpsertFail
...
<xsl:stylesheet
    ...
    xmlns:map="http://SBL_ContactWidget/xslt/ContactUpsertFail"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <dataObject>
            ...
            <xsl:call-template name="map:ContactUpsertFail2">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io3:smo" mode="map:ContactUpsertFail"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io3:smo" to "io3:smo".  -->
  <xsl:template match="io3:smo"  mode="map:ContactUpsertFail">
    <io3:smo>
      <body>
        <xsl:attribute name="xsi:type">
          <xsl:value-of select="'out3:ContactUpsert_fault1Msg'"/>
        </xsl:attribute>
  ...
  <xsl:template name="map:ContactUpsertFail2">
    <xsl:param name="smo"/>
    <body>
      <xsl:attribute name="xsi:type">
        <xsl:value-of select="'out3:ContactUpsert_fault1Msg'"/>
