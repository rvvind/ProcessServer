...
<!-- @generated mapFile="xslt/ContactUpsertToSBL.map" md5sum="36cb57f6cc132f9efd535b9224b931ae" version="7.0.401" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM XML Mapping Editor V7.0.401
*
*   Mapping file:		ContactUpsertToSBL.map
*   Map declaration(s):	ContactUpsertToSBL
...
<xsl:stylesheet
    ...
    xmlns:map="http://SBL_ContactWidget/xslt/ContactUpsertToSBL"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <dataObject>
            ...
            <xsl:call-template name="map:ContactUpsertToSBL2">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="body" mode="map:ContactUpsertToSBL"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "body" to "body".  -->
  <xsl:template match="body"  mode="map:ContactUpsertToSBL">
    <body>
      <xsl:attribute name="xsi:type">
        <xsl:value-of select="'out2:Contact_spcUpsert_spcWPS_spcCERN_ContactUpsert_Input'"/>
      </xsl:attribute>
      <out:Contact_spcUpsert_spcWPS_spcCERN_ContactUpsert_Input>
        <!-- a structural mapping: "in3:ContactUpsert/in4:Contact_spcUpsert_spcWPS_spcCERN_ContactUpsert_Input/in5:ListOfContactWpsCern"(ListOfContactWpsCern) to "io:ListOfContactWpsCern"(ListOfContactWpsCern) -->
        <xsl:apply-templates select="in3:ContactUpsert/in4:Contact_spcUpsert_spcWPS_spcCERN_ContactUpsert_Input/in5:ListOfContactWpsCern" mode="localListOfContactWpsCernToListOfContactWpsCern_602150152"/>
      </out:Contact_spcUpsert_spcWPS_spcCERN_ContactUpsert_Input>
    </body>
  </xsl:template>

  <!-- This rule represents a type mapping: "body" to "body".  -->
  <xsl:template name="map:ContactUpsertToSBL2">
    <xsl:param name="body"/>
    <out:Contact_spcUpsert_spcWPS_spcCERN_ContactUpsert_Input>
      <!-- a structural mapping: "$body/in3:ContactUpsert/in4:Contact_spcUpsert_spcWPS_spcCERN_ContactUpsert_Input/in5:ListOfContactWpsCern"(ListOfContactWpsCern) to "io:ListOfContactWpsCern"(ListOfContactWpsCern) -->
      <xsl:apply-templates select="$body/in3:ContactUpsert/in4:Contact_spcUpsert_spcWPS_spcCERN_ContactUpsert_Input/in5:ListOfContactWpsCern" mode="localListOfContactWpsCernToListOfContactWpsCern_602150152"/>
    </out:Contact_spcUpsert_spcWPS_spcCERN_ContactUpsert_Input>
  </xsl:template>

  <!-- This rule represents an element mapping: "in5:ListOfContactWpsCern" to "io:ListOfContactWpsCern".  -->
  <xsl:template match="in5:ListOfContactWpsCern"  mode="localListOfContactWpsCernToListOfContactWpsCern_602150152">
    <io:ListOfContactWpsCern>
      <!-- a for-each transform: "in5:Contact"(Contact) to "io:Contact"(Contact) -->
      <xsl:apply-templates select="in5:Contact" mode="localContactToContact_1659585596"/>
    </io:ListOfContactWpsCern>
  </xsl:template>

  <!-- This rule represents a for-each transform: "in5:Contact" to "io:Contact".  -->
  <xsl:template match="in5:Contact"  mode="localContactToContact_1659585596">
    <io:Contact>
      ...
      <xsl:apply-templates select="in5:ListOfContact_Account" mode="localListOfContact_AccountToListOfContact_Account_2103609164"/>
      ...
      <xsl:apply-templates select="in5:ListOfContact_BusinessAddress" mode="localListOfContact_BusinessAddressToListOfContact_BusinessAddress_957115458"/>
      ...
      <xsl:apply-templates select="in5:ListOfContact_AlternatePhone" mode="localListOfContact_AlternatePhoneToListOfContact_AlternatePhone_1471316806"/>
      <!-- a structural mapping: "in5:ListOfAccount"(ListOfAccount) to "io:ListOfAccount"(ListOfAccount) -->
      <xsl:apply-templates select="in5:ListOfAccount" mode="localListOfAccountToListOfAccount_687103011"/>
    </io:Contact>
  </xsl:template>

  <!-- This rule represents an element mapping: "in5:ListOfContact_Account" to "io:ListOfContact_Account".  -->
  <xsl:template match="in5:ListOfContact_Account"  mode="localListOfContact_AccountToListOfContact_Account_2103609164">
    <io:ListOfContact_Account>
      <!-- a for-each transform: "in5:Contact_Account"(Contact_Account) to "io:Contact_Account"(Contact_Account) -->
      <xsl:apply-templates select="in5:Contact_Account" mode="localContact_AccountToContact_Account_474820084"/>
    </io:ListOfContact_Account>
  </xsl:template>

  <!-- This rule represents a for-each transform: "in5:Contact_Account" to "io:Contact_Account".  -->
  <xsl:template match="in5:Contact_Account"  mode="localContact_AccountToContact_Account_474820084">
    <io:Contact_Account>
  ...
  <xsl:template match="in5:ListOfContact_BusinessAddress"  mode="localListOfContact_BusinessAddressToListOfContact_BusinessAddress_957115458">
    <io:ListOfContact_BusinessAddress>
      ...
      <xsl:apply-templates select="in5:Contact_BusinessAddress" mode="localContact_BusinessAddressToContact_BusinessAddress_2056365226"/>
    </io:ListOfContact_BusinessAddress>
  </xsl:template>

  <!-- This rule represents a for-each transform: "in5:Contact_BusinessAddress" to "io:Contact_BusinessAddress".  -->
  <xsl:template match="in5:Contact_BusinessAddress"  mode="localContact_BusinessAddressToContact_BusinessAddress_2056365226">
  ...
  <xsl:template match="in5:ListOfContact_AlternatePhone"  mode="localListOfContact_AlternatePhoneToListOfContact_AlternatePhone_1471316806">
    <io:ListOfContact_AlternatePhone>
      ...
      <xsl:apply-templates select="in5:Contact_AlternatePhone" mode="localContact_AlternatePhoneToContact_AlternatePhone_1213097878"/>
    </io:ListOfContact_AlternatePhone>
  </xsl:template>

  <!-- This rule represents a for-each transform: "in5:Contact_AlternatePhone" to "io:Contact_AlternatePhone".  -->
  <xsl:template match="in5:Contact_AlternatePhone"  mode="localContact_AlternatePhoneToContact_AlternatePhone_1213097878">
  ...
  <xsl:template match="in5:ListOfAccount"  mode="localListOfAccountToListOfAccount_687103011">
    <io:ListOfAccount>
      <!-- a for-each transform: "in5:Account"(Account) to "io:Account"(Account) -->
      <xsl:apply-templates select="in5:Account" mode="localAccountToAccount_1989520937"/>
    </io:ListOfAccount>
  </xsl:template>

  <!-- This rule represents a for-each transform: "in5:Account" to "io:Account".  -->
  <xsl:template match="in5:Account"  mode="localAccountToAccount_1989520937">
    <io:Account>
