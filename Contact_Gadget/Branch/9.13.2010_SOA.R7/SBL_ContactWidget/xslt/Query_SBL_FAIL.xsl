...
<!-- @generated mapFile="xslt/Query_SBL_FAIL.map" md5sum="5829c10bb31ad3322d38f1b63e4d7cca" version="7.0.200" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM XML Mapping Editor V7.0.200
*
*   Mapping file:		Query_SBL_FAIL.map
*   Map declaration(s):	Query_SBL_FAIL
...
<xsl:stylesheet
    ...
    xmlns:map="http://SBL_ContactWidget/xslt/SBL_FAIL"
  ...
  <!-- root template  -->
  <xsl:template match="/">
    <xsl:apply-templates select="io3:smo" mode="map:Query_SBL_FAIL"/>
  </xsl:template>

  <!-- This rule represents an element mapping: "io3:smo" to "io3:smo".  -->
  <xsl:template match="io3:smo"  mode="map:Query_SBL_FAIL">
    <io3:smo>
      <body>
