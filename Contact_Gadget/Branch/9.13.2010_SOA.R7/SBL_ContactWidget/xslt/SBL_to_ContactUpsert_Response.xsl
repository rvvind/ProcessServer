...
<!-- @generated mapFile="xslt/SBL_to_ContactUpsert_Response.map" md5sum="f2b5b92d3e1d0d92f8fd38a56a1afe0b" version="7.0.200" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM XML Mapping Editor V7.0.200
*
*   Mapping file:		SBL_to_ContactUpsert_Response.map
*   Map declaration(s):	SBL_to_ContactUpsert_Response
...
<xsl:stylesheet
    ...
    xmlns:map="http://SBL_ContactWidget/xslt/SBL_to_ContactUpsert_Response"
  ...
  <!-- root template  -->
  <xsl:template match="/">
    <xsl:apply-templates select="body" mode="map:SBL_to_ContactUpsert_Response"/>
  </xsl:template>

  <!-- This rule represents an element mapping: "body" to "body".  -->
  <xsl:template match="body"  mode="map:SBL_to_ContactUpsert_Response">
    <body>
      <out3:ContactUpsertResponse>
        <io5:Contact_spcUpsert_spcWPS_spcCERN_ContactUpsert_Output>
          <!-- a structural mapping: "io5:Contact_spcUpsert_spcWPS_spcCERN_ContactUpsert_Output_V2/io:ListOfContactWpsCern"(ListOfContactWpsCern) to "out4:ListOfContactWpsCern"(ListOfContactWpsCern) -->
          <xsl:apply-templates select="io5:Contact_spcUpsert_spcWPS_spcCERN_ContactUpsert_Output_V2/io:ListOfContactWpsCern" mode="localListOfContactWpsCernToListOfContactWpsCern_1474169358"/>
        </io5:Contact_spcUpsert_spcWPS_spcCERN_ContactUpsert_Output>
      </out3:ContactUpsertResponse>
    </body>
  </xsl:template>
  ...
  <xsl:template match="io:ListOfContactWpsCern"  mode="localListOfContactWpsCernToListOfContactWpsCern_1474169358">
    <out4:ListOfContactWpsCern>
      <!-- a for-each transform: "io:Contact"(Contact) to "out4:Contact"(Contact) -->
      <xsl:apply-templates select="io:Contact" mode="localContactToContact_2017481595"/>
    </out4:ListOfContactWpsCern>
  </xsl:template>

  <!-- This rule represents a for-each transform: "io:Contact" to "out4:Contact".  -->
  <xsl:template match="io:Contact"  mode="localContactToContact_2017481595">
    <out4:Contact>
      ...
      <xsl:apply-templates select="io:ListOfContact_Account" mode="localListOfContact_AccountToListOfContact_Account_1047735976"/>
      ...
      <xsl:apply-templates select="io:ListOfContact_BusinessAddress" mode="localListOfContact_BusinessAddressToListOfContact_BusinessAddress_1998601597"/>
      ...
      <xsl:apply-templates select="io:ListOfContact_AlternatePhone" mode="localListOfContact_AlternatePhoneToListOfContact_AlternatePhone_154055638"/>
      <!-- a structural mapping: "io:ListOfAccount"(ListOfAccount) to "out4:ListOfAccount"(ListOfAccount) -->
      <xsl:apply-templates select="io:ListOfAccount" mode="localListOfAccountToListOfAccount_961111588"/>
    </out4:Contact>
  </xsl:template>

  <!-- This rule represents an element mapping: "io:ListOfContact_Account" to "out4:ListOfContact_Account".  -->
  <xsl:template match="io:ListOfContact_Account"  mode="localListOfContact_AccountToListOfContact_Account_1047735976">
    <out4:ListOfContact_Account>
      ...
      <xsl:apply-templates select="io:Contact_Account" mode="localContact_AccountToContact_Account_1930973334"/>
    </out4:ListOfContact_Account>
  </xsl:template>

  <!-- This rule represents a for-each transform: "io:Contact_Account" to "out4:Contact_Account".  -->
  <xsl:template match="io:Contact_Account"  mode="localContact_AccountToContact_Account_1930973334">
  ...
  <xsl:template match="io:ListOfContact_BusinessAddress"  mode="localListOfContact_BusinessAddressToListOfContact_BusinessAddress_1998601597">
    <out4:ListOfContact_BusinessAddress>
      ...
      <xsl:apply-templates select="io:Contact_BusinessAddress" mode="localContact_BusinessAddressToContact_BusinessAddress_429018187"/>
    </out4:ListOfContact_BusinessAddress>
  </xsl:template>

  <!-- This rule represents a for-each transform: "io:Contact_BusinessAddress" to "out4:Contact_BusinessAddress".  -->
  <xsl:template match="io:Contact_BusinessAddress"  mode="localContact_BusinessAddressToContact_BusinessAddress_429018187">
  ...
  <xsl:template match="io:ListOfContact_AlternatePhone"  mode="localListOfContact_AlternatePhoneToListOfContact_AlternatePhone_154055638">
    <out4:ListOfContact_AlternatePhone>
      ...
      <xsl:apply-templates select="io:Contact_AlternatePhone" mode="localContact_AlternatePhoneToContact_AlternatePhone_17869397"/>
    </out4:ListOfContact_AlternatePhone>
  </xsl:template>

  <!-- This rule represents a for-each transform: "io:Contact_AlternatePhone" to "out4:Contact_AlternatePhone".  -->
  <xsl:template match="io:Contact_AlternatePhone"  mode="localContact_AlternatePhoneToContact_AlternatePhone_17869397">
  ...
  <xsl:template match="io:ListOfAccount"  mode="localListOfAccountToListOfAccount_961111588">
    <out4:ListOfAccount>
      <!-- a for-each transform: "io:Account"(Account) to "out4:Account"(Account) -->
      <xsl:apply-templates select="io:Account" mode="localAccountToAccount_539354625"/>
    </out4:ListOfAccount>
  </xsl:template>

  <!-- This rule represents a for-each transform: "io:Account" to "out4:Account".  -->
  <xsl:template match="io:Account"  mode="localAccountToAccount_539354625">
    <out4:Account>
