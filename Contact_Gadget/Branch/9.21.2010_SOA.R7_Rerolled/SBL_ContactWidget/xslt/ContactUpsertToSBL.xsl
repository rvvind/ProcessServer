...
<!-- @generated mapFile="xslt/ContactUpsertToSBL.map" md5sum="8c0452e5a178c833a2c95e93a9a003b7" version="7.0.200" -->
<!--
*****************************************************************************
...
<xsl:stylesheet
  ...
  <xsl:template match="body"  mode="map:ContactUpsertToSBL">
    <body>
      <out2:Contact_spcUpsert_spcWPS_spcCERN_ContactUpsert_Input>
        ...
        <xsl:apply-templates select="in3:ContactUpsert/in4:Contact_spcUpsert_spcWPS_spcCERN_ContactUpsert_Input/in5:ListOfContactWpsCern" mode="localListOfContactWpsCernToListOfContactWpsCern_722584640"/>
      </out2:Contact_spcUpsert_spcWPS_spcCERN_ContactUpsert_Input>
    </body>
  </xsl:template>

  <!-- This rule represents an element mapping: "in5:ListOfContactWpsCern" to "io:ListOfContactWpsCern".  -->
  <xsl:template match="in5:ListOfContactWpsCern"  mode="localListOfContactWpsCernToListOfContactWpsCern_722584640">
    <io:ListOfContactWpsCern>
      <!-- a for-each transform: "in5:Contact"(Contact) to "io:Contact"(Contact) -->
      <xsl:apply-templates select="in5:Contact" mode="localContactToContact_830972814"/>
    </io:ListOfContactWpsCern>
  </xsl:template>

  <!-- This rule represents a for-each transform: "in5:Contact" to "io:Contact".  -->
  <xsl:template match="in5:Contact"  mode="localContactToContact_830972814">
    <io:Contact>
      ...
      <xsl:apply-templates select="in5:ListOfContact_Account" mode="localListOfContact_AccountToListOfContact_Account_1821926979"/>
      ...
      <xsl:apply-templates select="in5:ListOfContact_BusinessAddress" mode="localListOfContact_BusinessAddressToListOfContact_BusinessAddress_136320922"/>
      ...
      <xsl:apply-templates select="in5:ListOfContact_AlternatePhone" mode="localListOfContact_AlternatePhoneToListOfContact_AlternatePhone_105118086"/>
      <!-- a structural mapping: "in5:ListOfAccount"(ListOfAccount) to "io:ListOfAccount"(ListOfAccount) -->
      <xsl:apply-templates select="in5:ListOfAccount" mode="localListOfAccountToListOfAccount_429631987"/>
    </io:Contact>
  </xsl:template>

  <!-- This rule represents an element mapping: "in5:ListOfContact_Account" to "io:ListOfContact_Account".  -->
  <xsl:template match="in5:ListOfContact_Account"  mode="localListOfContact_AccountToListOfContact_Account_1821926979">
    <io:ListOfContact_Account>
      <!-- a for-each transform: "in5:Contact_Account"(Contact_Account) to "io:Contact_Account"(Contact_Account) -->
      <xsl:apply-templates select="in5:Contact_Account" mode="localContact_AccountToContact_Account_1108995187"/>
    </io:ListOfContact_Account>
  </xsl:template>

  <!-- This rule represents a for-each transform: "in5:Contact_Account" to "io:Contact_Account".  -->
  <xsl:template match="in5:Contact_Account"  mode="localContact_AccountToContact_Account_1108995187">
    <io:Contact_Account>
  ...
  <xsl:template match="in5:ListOfContact_BusinessAddress"  mode="localListOfContact_BusinessAddressToListOfContact_BusinessAddress_136320922">
    <io:ListOfContact_BusinessAddress>
      ...
      <xsl:apply-templates select="in5:Contact_BusinessAddress" mode="localContact_BusinessAddressToContact_BusinessAddress_998868009"/>
    </io:ListOfContact_BusinessAddress>
  </xsl:template>

  <!-- This rule represents a for-each transform: "in5:Contact_BusinessAddress" to "io:Contact_BusinessAddress".  -->
  <xsl:template match="in5:Contact_BusinessAddress"  mode="localContact_BusinessAddressToContact_BusinessAddress_998868009">
  ...
  <xsl:template match="in5:ListOfContact_AlternatePhone"  mode="localListOfContact_AlternatePhoneToListOfContact_AlternatePhone_105118086">
    <io:ListOfContact_AlternatePhone>
      ...
      <xsl:apply-templates select="in5:Contact_AlternatePhone" mode="localContact_AlternatePhoneToContact_AlternatePhone_653655712"/>
    </io:ListOfContact_AlternatePhone>
  </xsl:template>

  <!-- This rule represents a for-each transform: "in5:Contact_AlternatePhone" to "io:Contact_AlternatePhone".  -->
  <xsl:template match="in5:Contact_AlternatePhone"  mode="localContact_AlternatePhoneToContact_AlternatePhone_653655712">
  ...
  <xsl:template match="in5:ListOfAccount"  mode="localListOfAccountToListOfAccount_429631987">
    <io:ListOfAccount>
      <!-- a for-each transform: "in5:Account"(Account) to "io:Account"(Account) -->
      <xsl:apply-templates select="in5:Account" mode="localAccountToAccount_1475774711"/>
    </io:ListOfAccount>
  </xsl:template>

  <!-- This rule represents a for-each transform: "in5:Account" to "io:Account".  -->
  <xsl:template match="in5:Account"  mode="localAccountToAccount_1475774711">
    <io:Account>
