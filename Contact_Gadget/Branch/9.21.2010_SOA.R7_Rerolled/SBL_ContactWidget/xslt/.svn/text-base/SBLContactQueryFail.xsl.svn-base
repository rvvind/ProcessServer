...
<!-- @generated mapFile="xslt/SBLContactQueryFail.map" md5sum="83cc17be4de06dadd76373a8018f10e8" version="7.0.200" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM XML Mapping Editor V7.0.200
*
*   Mapping file:		SBLContactQueryFail.map
*   Map declaration(s):	SBLContactQueryFail
...
<xsl:stylesheet
    ...
    xmlns:map="http://SBL_ContactWidget/xslt/SBLContactQueryFail"
  ...
  <!-- root template  -->
  <xsl:template match="/">
    <xsl:apply-templates select="io3:smo" mode="map:SBLContactQueryFail"/>
  </xsl:template>

  <!-- This rule represents an element mapping: "io3:smo" to "io3:smo".  -->
  <xsl:template match="io3:smo"  mode="map:SBLContactQueryFail">
    <io3:smo>
      <body>
